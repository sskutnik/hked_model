...
10    1  -1.7     -100  102                                  IMP:P=1 IMP:E=1 
c Sample vial
11    2   -0.98        100 -101  102                          IMP:P=1 IMP:E=1
c Sample solution, force photon collisions in this cell
c 10    17   -16.81       -100  102                             IMP:P=1 IMP:E=1 
c Sample vial
c 11    3   -0.001293      100 -101  102                        IMP:P=1 IMP:E=1
c Air gap within the sample vial
12    3   -0.001293   -102                                      IMP:P=1 IMP:E=1
c X-ray tube
...
20    6   -8.03        101 -112  113  111 -999                  IMP:P=5 IMP:E=1
