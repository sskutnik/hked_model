c HKED Model Geometry, v.10, MCook
c --- CELL CARDS ---
c --- CORE COMPONENTS ---
c Sample solution, force photon collisions in this cell
10    14  -1.7   -100                                      IMP:P=1 IMP:E=1 
c Sample vial
11    18   -2.6        100 -101                              IMP:P=1 IMP:E=1
c Sample solution, force photon collisions in this cell
c 10    17   -16.81   -100                         FCL:P=1   IMP:P=1 IMP:E=1 
c Sample vial
c 11    2   -0.98        100 -101                            IMP:P=1 IMP:E=1
...
98    0                #10 #11     #13 #14 #15 #16 #17 #18 #19
                       #20 #21
...
100   RPP    6.0   6.1     -1.0   1.0    -0.98   3.214
101   RPP    5.9   6.2     -1.2   1.2    -1.28   5.85
...
c XRF gadolinium foil, assume 0.1 mm thickness (Contact Bob & Tyler to verify)
